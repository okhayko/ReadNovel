...
const TTSPlayerMobile: React.FC<TTSPlayerProps> = ({ content, onIndexChange, currentIndex, isPlaying, setIsPlaying, settings }) => {
    ...
    return (
        <div className="flex flex-col gap-4 p-4 bg-app-surface/50 backdrop-blur-md border border-app-border rounded-2xl mb-8 relative">
            ...
            <div className="flex items-center justify-between w-full gap-4 relative z-10">
                ...
                <div className="flex items-center gap-1">
                    ...
                    <button 
                        ...
                        className="w-10 h-10 rounded-full bg-app-accent text-app-bg flex items-center justify-center hover:scale-105 transition-transform shadow-lg shadow-app-accent/20"
                    >
            ...
            <div className="flex items-center gap-3 w-full px-1">
                <Volume2 size={14} className="text-app-textMuted shrink-0" />
                ...
                <span className="text-[10px] font-mono text-app-textMuted w-8 text-right">{rate}x</span>
            </div>
            
            {isPlaying && (
                <div className="text-[9px] text-app-accent/70 font-medium uppercase tracking-widest animate-pulse text-center w-full">
